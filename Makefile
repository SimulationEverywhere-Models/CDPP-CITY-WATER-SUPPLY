...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  pump.o register.o reservoir.o well_pump.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#9
...
#^|
pump.o: /cygdrive/C/eclipse/workspace/qw/pump.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/qw/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
reservoir.o: /cygdrive/C/eclipse/workspace/qw/reservoir.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
well_pump.o: /cygdrive/C/eclipse/workspace/qw/well_pump.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
pump.o: /cygdrive/C/eclipse/workspace/qw/pump.cpp \
 /cygdrive/C/eclipse/workspace/qw/pump.h \
...
register.o: /cygdrive/C/eclipse/workspace/qw/register.cpp \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/portlist.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/workspace/qw/reservoir.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/qw/pump.h \
 /cygdrive/C/eclipse/workspace/qw/well_pump.h
reservoir.o: /cygdrive/C/eclipse/workspace/qw/reservoir.cpp \
 /cygdrive/C/eclipse/workspace/qw/reservoir.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
